...
import NavBulma from '../Navigation/NavBulma';
          ...
          <div
            ...
            <div className="terminal-header is-flex is-justify-content-space-between m-1">
              <div className="terminal-buttons">
                <span className="terminal-button close button is-danger is-small is-rounded mr-1"></span>
                <span className="terminal-button minimize button is-warning is-small is-rounded mr-1"></span>
                <span className="terminal-button maximize button is-success is-small is-rounded mr-1"></span>
              </div>
            ...
            <div className="terminal-body" ref={terminalRef}>
              <div className="command-output">
                ...
                <div className="container">
                  <div className="column is-full">
                    <p className={`${theme === 'dark' ? 'has-text-light' : 'has-text-dark'} m-0`}>
                    ...
                    <div className="columns is-multiline is-mobile is-2">
                      {resumeData.technology_stack.map((tech: string, index: number) => (
                        <div key={index}
                          ...
                          >
                            <i className={`devicon-${tech.toLowerCase().replace(/\s+/g, '')}-plain colored mr-2`}></i>
                            <span>{tech}</span>
                          </div>
                        </div>
                      ))}
                    ...
                    <div className="columns is-multiline is-mobile is-2">
                      {resumeData.tools.map((tool: string, index: number) => (
                        <div key={index}
                          ...
                          >
                            <i className={`devicon-${tool.toLowerCase().replace(/\s+/g, '')}-plain colored mr-2`}></i>
                            <span>{tool}</span>
                          </div>
                        </div>
                      ))}
